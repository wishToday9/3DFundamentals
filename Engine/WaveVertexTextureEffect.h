...
public:
	...
	//calculate lighting intensity base on light direction
	...
	private:
		Mat3 rotation;
		Vec3 translation;
		//direction of tracel of light rays
		Vec3 dir = { 0.0f,0.0f,1.0f };
		//this is the intensity of direct light frome source
		//white light so only need 1 channel to represent it
		float diffuse = 1.0f;
		//this is intensity of indirect light that bounces pff other obj in scene
		float ambient = 0.15f;
	};
	...
	public:
		...
		Color operator()(const Input& in) const
		{
			...
			// of the different color compoments diffuse reflected from triangle at this pt
